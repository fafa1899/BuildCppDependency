...
CMakeArgs="-DUSE_LOCKING=ON -DBUILD_TESTING=OFF -DBUILD_SHARED_LIBS=ON -DBUILD_STATIC_LIBS=OFF -DBUILD_RELAPACK=ON -DC_LAPACK=ON"
TargetFile="${InstallDir}/lib/libopenblas.so"
